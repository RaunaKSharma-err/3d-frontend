    ...
    <>
      <div className="absolute top-0 h-[60px] w-[100%] text-5xl flex justify-between px-3 items-center">
        <img
          src="A.png"
          alt="Logo"
          className="h-20 mt-12 animate-slide-from-top z-10"
        />
        <div className="text-sm gap-12 ml-90 flex font-bold animate-slide-from-top text-white z-50">
        ...
        <div className="flex justify-between items-center w-[400px]">
          <div className="z-50 flex justify-center items-center gap-2">
            <Input className="border-gray-800 border-2 rounded-full bg-[#ebebeb] text-gray-800 font-bold" placeholder="Search..."/>
